                                ...
                                <div class="dor-topbar-line-inner">
                                    <div class="dor-topbar-line-wrapper row">
                                        <div class="topbar-infomation col-lg-8 col-sm-8 pull-left">
                                            <ul>
                                                <li class="time-work"><span><i class="material-icons"></i> Work time:
                                            ...
                                            <div id="dor-top-menu" class="collapse navbar-collapse navbar-ex1-collapse">
                                                ...
                                                <ul class="nav navbar-nav megamenu">
                                                    ...
                                                    <li class=" parent dropdown aligned-fullwidth"><a
                                                            ...
                                                            class="caretmobile hidden"></span>
                                                        <ul class="dropdown-menu level1 megamenu-content" role="menu"
                                                            style="background-image:url(../img/cms/dorado/menu/smartphone_bg.png);background-repeat:no-repeat;width:900px;">
                                                            <li>
                                                                <div class="row">
                                                                    <div class="col-sm-3">
                                                                        <div class="widget-content">
                                                                                ...
                                                                                <div class="widget-inner block_content">
                                                                                    <div id="tabs1885168505"
                                                                                        ...
                                                                                        <ul class="nav-links"
                                                                                            ...
                                                                                            <li><a
                                                                                                    href="3-shop1cb2.html?info_style=default"><i
                                                                                                        class=''></i>Product
                                                                                                    Info Standard</a>
                                                                                            </li>

                                                                                            <li><a
                                                                                                    href="3-shopd2cf.html?info_style=accord1"><i
                                                                                                        class=''></i>Product
                                                                                                    Info Accordion 1</a>
                                                                                            </li>

                                                                                            <li><a
                                                                                                    href="3-shop0991.html?info_style=accord2"><i
                                                                                                        class=''></i>Product
                                                                                                    Info Accordion 2</a>
                                                                                            </li>

                                                                                            <li><a
                                                                                                    href="3-shop225e.html?info_style=scroll"><i
                                                                                                        class=''></i>Product
                                                                                                    Info Scroll</a></li>
                                                                                        </ul>
                                                                                    </div>
                                                                                ...
                                                                                <div class="widget-inner block_content">
                                                                                    <div id="tabs61122742"
                                                                                        ...
                                                                                        <ul class="nav-links"
                                                                                            ...
                                                                                            <li><a
                                                                                                    href="3-shopb560.html?cart_style=1"><i
                                                                                                        class=''></i>Mini
                                                                                                    Cart Standard</a>
                                                                                            </li>

                                                                                            <li><a
                                                                                                    href="3-shopad12.html?cart_style=2"><i
                                                                                                        class=''></i>Mini
                                                                                                    Cart Slick</a></li>
                                                                                        </ul>
                                                                                    </div>
